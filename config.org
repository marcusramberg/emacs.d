...
#+BEGIN_SRC emacs-lisp
    (use-package general :defer t :config
      ...
      (space-leader :keymaps 'normal "c-SPC" '(smex-major-mode :which-key "smex"))
      ;; SPC SPC
      (space-leader :keymaps 'normal "g" '(magit-status :which-key "Git status"))

      ;; SPC b
      (general-create-definer space-b-leader :prefix "SPC b" :which-key "Buffer")
      ;; SPC b b
      ...
      ;; SPC f
      (general-create-definer space-f-leader :prefix "SPC f" :which-key "File")
      ;; SPC f f
      ...
      ;; SPC h
      (general-create-definer space-h-leader :prefix "SPC h" :which-key "Help")
      ;; SPC h f
      (space-h-leader :keymaps 'normal "f" '(describe-function :which-key "Describe Function"))

      ;; SPC o
      (general-create-definer space-o-leader :prefix "SPC o" :which-key "Open")
