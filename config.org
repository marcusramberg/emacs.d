...
#+BEGIN_SRC emacs-lisp
    (use-package general :defer t :config
      (general-evil-setup)
      (general-create-definer space-leader :keymaps '(normal visual) :prefix "SPC")
      ...
      (space-leader :keymaps 'normal "v" '(counsel-yank-pop :which-key "paste from kill ring"))
      (space-leader :keymaps 'normal ":" '(eval-expression :which-key "eval"))
      (space-leader :keymaps 'normal "," '(buffer-menu :which-key "buffers"))
      (space-leader :keymaps 'normal "." '(previous-buffer :which-key "previous"))
      ;; SPC SPC
      ...
      (space-b-leader :keymaps 'normal "s" '(evil-save :which-key "save"))
      ...
      (space-s-leader :keymaps 'normal "g" '(counsel-rg :which-key "rg"))
      (space-s-leader :keymaps 'normal "m" '(counsel-imenu :which-key "menu"))
